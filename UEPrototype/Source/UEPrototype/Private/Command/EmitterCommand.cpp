...
UActorConstraintMarker* UEmitterCommand::ActorConstraintMarker = nullptr;

UEmitterCommand::UEmitterCommand()
{
	VP_CTOR;
...
void UEmitterCommand::ExecuteIf()
{
...
void UEmitterCommand::InitActorCommand(FActorConstraintInfo TargetInfo)
{
	Target = TargetInfo;
}
