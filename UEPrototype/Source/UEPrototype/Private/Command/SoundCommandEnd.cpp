...
UActorConstraintMarker* USoundCommandEnd::ActorConstraintMarker = nullptr;
USoundCommandEnd::USoundCommandEnd()
{
	VP_CTOR;
...
void USoundCommandEnd::ExecuteIf()
{
	if (IsValid(ActorConstraintMarker) == false)
	{
...
void USoundCommandEnd::InitActorCommand(FActorConstraintInfo TargetInfo)
{
	Target = TargetInfo;
}
