...
UActorConstraintMarker* UScaleEndCommand::ActorConstraintMarker = nullptr;

UScaleEndCommand::UScaleEndCommand()
{
	VP_CTOR;
...
void UScaleEndCommand::ExecuteIf()
{
...
void UScaleEndCommand::InitActorCommand(FActorConstraintInfo TargetInfo)
{
	Target = TargetInfo;
}
