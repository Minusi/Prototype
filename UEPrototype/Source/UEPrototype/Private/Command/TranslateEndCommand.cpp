...
UActorConstraintMarker* UTranslateEndCommand::ActorConstraintMarker = nullptr;

UTranslateEndCommand::UTranslateEndCommand()
{
...
void UTranslateEndCommand::ExecuteIf()
{
	if (IsValid(ActorConstraintMarker) == false)
	{
...
void UTranslateEndCommand::InitActorCommand(FActorConstraintInfo TargetInfo)
{
