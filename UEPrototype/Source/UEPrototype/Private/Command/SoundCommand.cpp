...
UActorConstraintMarker* USoundCommand::ActorConstraintMarker = nullptr;


USoundCommand::USoundCommand()
{
	VP_CTOR;
...
void USoundCommand::InitActorCommand(FActorConstraintInfo TargetInfo)
{
	Target = TargetInfo;
}
