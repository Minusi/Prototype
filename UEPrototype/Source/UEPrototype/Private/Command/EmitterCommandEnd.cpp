...
UActorConstraintMarker* UEmitterCommandEnd::ActorConstraintMarker = nullptr;

UEmitterCommandEnd::UEmitterCommandEnd()
{
	VP_CTOR;
...
void UEmitterCommandEnd::ExecuteIf()
{
	if (IsValid(ActorConstraintMarker) == false)
	{
...
void UEmitterCommandEnd::InitActorCommand(FActorConstraintInfo TargetInfo)
{
	Target = TargetInfo;
}
