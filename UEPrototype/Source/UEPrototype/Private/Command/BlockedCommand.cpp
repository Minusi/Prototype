...
UActorConstraintMarker* UBlockedCommand::ActorConstraintMarker = nullptr;

UBlockedCommand::UBlockedCommand() 
{
...
void UBlockedCommand::ExecuteIf()
{
...
void UBlockedCommand::InitActorCommand(FActorConstraintInfo TargetInfo)
{
	Target = TargetInfo;
}
